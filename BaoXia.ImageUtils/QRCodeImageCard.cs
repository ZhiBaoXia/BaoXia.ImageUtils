...
public class QRCodeImageCard(
    ...
    double imageFileCacheValidSecondsDefault = ImageCard.ImageFileCacheValidSecondsDefault
)
    : ImageCard(
        debugLogFile,
        null,
    ...
    )
{
        ...
        )
        {
                ...
                return await ToImageCardInfoAsync<string, object>(
                    ...
                    fileDownloadName,
                    null,
                    (httpClient, imageDownloader, getDataParam) =>
                    {
                    ...
                    {
                            var qrCodeFrame = SKRect.Create(
                        canvasPadding.Left,
                        canvasPadding.Top,
                        canvasWidth - canvasPadding.Width,
                        canvasHeightMax - canvasPadding.Height
                    );
                            var qrImage = QRCodeGenerator.CreateQrCode(
                        qrCodeText,
                        qrCodeECCLevel,
                        false,
                        EciMode.Default,
                        ...
                        backgroundColorHex != null
                            ...
                            : SKColors.Empty;
                            var codeColor =
                        codeColorHex != null ? ColorFromArgbHex(codeColorHex.Value) : SKColors.Black;
                            ////////////////////////////////////////////////
                            canvas.Render(
                        qrImage,
                        qrCodeFrame,
